...
return [
    ...
    */
    ...
    'loggerDatabaseConnection'  => env('LARAVEL_LOGGER_DATABASE_CONNECTION', 'sqlite'),
    ...
    */
    ...
    'defaultActivityModel' => env('LARAVEL_LOGGER_ACTIVITY_MODEL', 'Modules\System\Entities\Activity'),
