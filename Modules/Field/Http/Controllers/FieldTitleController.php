...
class FieldTitleController extends Controller
{
    /**
    ...
    {
        if ($request->user()->cannot('viewAny', FieldTitle::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Core/Field/FieldTitle/Index', []);
        }
    }
    ...
    {
        if ($request->user()->cannot('create', FieldTitle::class)) {
        ...
        return Inertia::render('Core/Field/FieldTitle/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = FieldTitle::create($data);
        $statusText = 'FieldTitle "' . $entity['name'] . '" has been created';
    ...
    {
        $entity = FieldTitle::findOrFail($id);
        ...
        return Inertia::render('Core/Field/FieldTitle/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Core/Field/FieldTitle/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $statusText = 'Title "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'Title "' . $entity['name'] . '" has been deleted';
        $entity->delete();
