...
class FieldLinkController extends Controller
{
    ...
    {
        if ($request->user()->cannot('viewAny', FieldLink::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Core/Field/FieldLink/Index', []);
        }
    }
    ...
    {
        if ($request->user()->cannot('create', FieldLink::class)) {
        ...
        return Inertia::render('Core/Field/FieldLink/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = FieldLink::create($data);
        $statusText = 'FieldLink "' . $entity['name'] . '" has been created';
    ...
    {
        $entity = FieldLink::findOrFail($id);
        ...
        return Inertia::render('Core/Field/FieldLink/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Core/Field/FieldLink/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $statusText = 'Link "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'Link "' . $entity['name'] . '" has been deleted';
        $entity->delete();
