...
class FieldTextController extends Controller
{
    ...
    {
        if ($request->user()->cannot('viewAny', FieldText::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Core/Field/FieldText/Index', []);
        }
    }
    ...
    {
        if ($request->user()->cannot('create', FieldText::class)) {
        ...
        return Inertia::render('Core/Field/FieldText/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = FieldText::create($data);
        $statusText = 'Text "' . $entity['name'] . '" has been created';
    ...
    {
        $entity = FieldText::findOrFail($id);
        ...
        return Inertia::render('Core/Field/FieldText/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Core/Field/FieldText/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $statusText = 'Text "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'Text "' . $entity['name'] . '" has been deleted';
        $entity->delete();
