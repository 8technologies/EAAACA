...
class FieldImageController extends Controller
{
    ...
    {
        if ($request->user()->cannot('viewAny', FieldImage::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Core/Field/FieldImage/Index', []);
        }
    }
    ...
    {
        if ($request->user()->cannot('create', FieldImage::class)) {
        ...
        return Inertia::render('Core/Field/FieldImage/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = FieldImage::create($data);
        $entity->uploadOrAttachMedia($request);
        $statusText = 'Image "' . $entity['name'] . '" has been created';
    ...
    {
        $entity = FieldImage::findOrFail($id);
        ...
        return Inertia::render('Core/Field/FieldImage/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Core/Field/FieldImage/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $entity->uploadOrAttachMedia($request);
        $statusText = 'Image "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'Image "' . $entity['name'] . '" has been deleted';
        $entity->detachMedia();
        $entity->delete();
