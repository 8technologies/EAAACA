...
class FieldHtmlController extends Controller
{
    /**
    ...
    {
        if ($request->user()->cannot('viewAny', FieldHtml::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Core/Field/FieldHtml/Index', []);
        }
    }
    ...
    {
        if ($request->user()->cannot('create', FieldHtml::class)) {
        ...
        return Inertia::render('Core/Field/FieldHtml/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = FieldHtml::create($data);
        $statusText = 'Html "' . $entity['name'] . '" has been created';
    ...
    {
        $entity = FieldHtml::findOrFail($id);
        ...
        return Inertia::render('Core/Field/FieldHtml/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Core/Field/FieldHtml/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $statusText = 'Html "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'Html "' . $entity['name'] . '" has been deleted';
        $entity->delete();
