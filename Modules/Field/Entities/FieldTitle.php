...
class FieldTitle extends Model
{
    use HasFactory;
    use SearchableTrait;
    use Filterable;
    ...
    {
        $links = [
            'url'  => route('dashboard.field_titles.show', [$this->attributes['id']]),
            'url_view'  => route('dashboard.field_titles.show', [$this->attributes['id']]),
            'url_edit'  => route('dashboard.field_titles.edit', [$this->attributes['id']]),
        ];
    ...
    {
        return \Modules\Field\Database\factories\FieldTitleFactory::new();
    }
}
