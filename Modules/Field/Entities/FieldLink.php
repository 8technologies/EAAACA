...
class FieldLink extends Model
{
    ...
    {
        $links = [
            'url'  => route('dashboard.field_links.show', [$this->attributes['id']]),
            'url_view'  => route('dashboard.field_links.show', [$this->attributes['id']]),
            'url_edit'  => route('dashboard.field_links.edit', [$this->attributes['id']]),
        ];
    ...
    {
        return \Modules\Field\Database\factories\FieldLinkFactory::new();
    }
}
