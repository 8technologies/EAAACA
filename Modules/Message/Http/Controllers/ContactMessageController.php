...
class ContactMessageController extends Controller
{
    ...
    {
        if ($request->user()->cannot('viewAny', ContactMessage::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Core/Message/ContactMessage/Index', []);
        }
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return Inertia::render('Core/Message/ContactMessage/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Core/Message/ContactMessage/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $statusText = 'ContactMessage "' . $entity['id'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'ContactMessage "' . $entity['id'] . '" has been deleted';
        $entity->delete();
