...
class MediaProviderController extends Controller
{
    ...
    {
        if ($request->user()->cannot('viewAny', MediaProvider::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Core/Media/Provider/Index', []);
        }
    }
    ...
    {
        if ($request->user()->cannot('create', MediaProvider::class)) {
        ...
        return Inertia::render('Core/Media/Provider/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = MediaProvider::create($data);
        $statusText = 'Provider "' . $entity['name'] . '" has been created';
    ...
    {
        $entity = MediaProvider::findOrFail($id);
        ...
        return Inertia::render('Core/Media/Provider/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Core/Media/Provider/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $statusText = 'Provider "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'Provider "' . $entity['name'] . '" has been deleted';
        $entity->delete();
