...
class TaxonomyTypeController extends Controller
{
    ...
    {
        if ($request->user()->cannot('viewAny', TaxonomyType::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Core/Taxonomy/Type/Index', []);
        }
    }
    ...
    {
        if ($request->user()->cannot('create', TaxonomyType::class)) {
        ...
        return Inertia::render('Core/Taxonomy/Type/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = TaxonomyType::create($data);
        $statusText = 'TaxonomyType "' . $entity['name'] . '" has been created';
    ...
    {
        $entity = TaxonomyType::findOrFail($id);
        ...
        return Inertia::render('Core/Taxonomy/Type/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Core/Taxonomy/Type/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $statusText = 'TaxonomyType "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'TaxonomyType "' . $entity['name'] . '" has been deleted';
        $entity->delete();
