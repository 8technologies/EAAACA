...
class PermissionTypeController extends Controller
{
    ...
    {
        if ($request->user()->cannot('viewAny', PermissionType::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Core/RolePermission/PermissionType/Index', []);
        }
    }
    ...
    {
        if ($request->user()->cannot('create', PermissionType::class)) {
        ...
        return Inertia::render('Core/RolePermission/PermissionType/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = PermissionType::create($data);
        $statusText = 'PermissionType "' . $entity['name'] . '" has been created';
    ...
    {
        $entity = PermissionType::findOrFail($id);
        ...
        return Inertia::render('Core/RolePermission/PermissionType/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Core/RolePermission/PermissionType/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $statusText = 'PermissionType "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'PermissionType "' . $entity['name'] . '" has been deleted';
        $entity->delete();
