...
class CommentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Core/Comment/Index', []);
        }
    }
    ...
    public function create(Request $request)
    {
        ...
        return Inertia::render('Core/Comment/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = Comment::create($data);
        $entity->updateRelatedEntities($request);
        $statusText = 'Comment "' . $entity['name'] . '" has been created';

        if(checkAjaxJsonRequest($request))
        {
            return response($entity)->setStatusCode(200, $statusText);
        }
        return redirect()->route('dashboard.comments.index')->with('success', $statusText);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return Inertia::render('Core/Comment/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Core/Comment/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $entity->updateRelatedEntities($request);
        $statusText = 'Comment "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'Comment "' . $entity['name'] . '" has been deleted';
        $entity->delete();
