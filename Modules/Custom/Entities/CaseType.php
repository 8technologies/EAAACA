...
class CaseType extends Model
{
    ...
    {
        $links = [
            'url'  => route('dashboard.case-types.show', [$this->attributes['id']]),
            'url_view'  => route('dashboard.case-types.show', [$this->attributes['id']]),
            'url_edit'  => route('dashboard.case-types.edit', [$this->attributes['id']]),
        ];
    ...
    {
        return \Modules\Custom\Database\factories\CaseTypeFactory::new();
    }
}
