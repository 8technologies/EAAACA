...
class NatureOfOffence extends Model
{
    use HasFactory;
    use ContentModel;
    use HasMediaField;
    ...
    protected $searchable = [
         ...
         */
        'columns' => [
            'nature_of_offences.name' => 10,
            'nature_of_offences.description' => 10,
        ],
    ];
    ...
    {
        $links = [
            'url'  => route('dashboard.nature-of-offences.show', [$this->attributes['id']]),
            'url_view'  => route('dashboard.nature-of-offences.show', [$this->attributes['id']]),
            'url_edit'  => route('dashboard.nature-of-offences.edit', [$this->attributes['id']]),
        ];
    ...
    {
        return \Modules\Custom\Database\factories\NatureOfOffenceFactory::new();
    }
}
