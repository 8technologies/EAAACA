...
class InternalCommunication extends Model
{
    ...
    protected $searchable = [
         ...
         */
        'columns' => [
            'internal_communications.title' => 10,
            'internal_communications.description' => 10,
        ],
    ];
    ...
    {
        $links = [
            'url'  => route('dashboard.internal-communications.show', [$this->attributes['id']]),
            'url_view'  => route('dashboard.internal-communications.show', [$this->attributes['id']]),
            'url_edit'  => route('dashboard.internal-communications.edit', [$this->attributes['id']]),
        ];
    ...
    {
        return \Modules\Custom\Database\factories\InternalCommunicationFactory::new();
    }
}
