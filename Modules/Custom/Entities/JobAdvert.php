...
class JobAdvert extends Model
{
    ...
    public function getEntityLinksAttribute()
    {
        ...
        $links = [
            'url'  => route('job-adverts.show', [$urlParam]),
            'url_view'  => route('dashboard.job-adverts.show', [$this->attributes['id']]),
            'url_edit'  => route('dashboard.job-adverts.edit', [$this->attributes['id']]),
        ];
    ...
    {
        return \Modules\Custom\Database\factories\JobAdvertFactory::new();
    }
}
