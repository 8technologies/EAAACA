...
class MemberState extends Model
{
    ...
    protected $searchable = [
         ...
         */
        'columns' => [
            'member_states.name' => 10,
            'member_states.description' => 10,
        ],
    ];
    ...
    {
        $links = [
            'url'  => route('dashboard.member-states.show', [$this->attributes['id']]),
            'url_view'  => route('dashboard.member-states.show', [$this->attributes['id']]),
            'url_edit'  => route('dashboard.member-states.edit', [$this->attributes['id']]),
        ];
    ...
    {
        return \Modules\Custom\Database\factories\MemberStateFactory::new();
    }
}
