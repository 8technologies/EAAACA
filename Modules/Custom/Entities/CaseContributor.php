...
class CaseContributor extends Model
{
    ...
    {
        return $this->contact_point->name;
    }
    ...
    {
        $links = [
            'url'  => route('dashboard.case-contributors.show', [$this->attributes['id']]),
            'url_view'  => route('dashboard.case-contributors.show', [$this->attributes['id']]),
            'url_edit'  => route('dashboard.case-contributors.edit', [$this->attributes['id']]),
        ];
    ...
    {
        return \Modules\Custom\Database\factories\CaseContributorFactory::new();
    }
}
