...
class ForumCategory extends Model
{
    ...
    protected $searchable = [
         ...
         */
        'columns' => [
            'forum_categories.name' => 10,
            'forum_categories.body' => 10,
        ],
    ];
    ...
    {
        $links = [
            'url'  => route('dashboard.forum-categories.show', [$this->attributes['id']]),
            'url_view'  => route('dashboard.forum-categories.show', [$this->attributes['id']]),
            'url_edit'  => route('dashboard.forum-categories.edit', [$this->attributes['id']]),
        ];
    ...
    {
        return \Modules\Custom\Database\factories\ForumCategoryFactory::new();
    }
}
