...
class ForumTopicController extends Controller
{
    ...
    {
        if ($request->user()->cannot('viewAny', ForumTopic::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Custom/ForumTopic/Index', []);
        }
    }
    ...
    public function getData(Request $request)
    {
        ...
        $data = ForumTopic::
            with('media', 'user', 'forum_category')
            ->filter($request->all())
            ->search($query)
    ...
    {
        if ($request->user()->cannot('create', ForumTopic::class)) {
        ...
        return Inertia::render('Custom/ForumTopic/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = ForumTopic::create($data);
        $entity->updateRelatedEntities($request);
        $statusText = 'Forum Topic "' . $entity['name'] . '" has been created';

        if(checkAjaxJsonRequest($request))
        {
            return response($entity)->setStatusCode(200, $statusText);
        }
        return redirect()->route('dashboard.forum-topics.index')->with('success', $statusText);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return Inertia::render('Custom/ForumTopic/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Custom/ForumTopic/Edit', ['data' => $entity]);
    }
    ...
    {
        $entity = ForumTopic::findOrFail($id);
        ...
        $entity->updateRelatedEntities($request);
        $statusText = 'Forum Topic "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'Forum Topic "' . $entity['name'] . '" has been deleted';
        $entity->delete();
