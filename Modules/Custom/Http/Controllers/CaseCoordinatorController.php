...
class CaseCoordinatorController extends Controller
{
    /**
    ...
    {
        if ($request->user()->cannot('viewAny', CaseCoordinator::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Custom/CaseCoordinator/Index', []);
        }
    }
    ...
    {
        if ($request->user()->cannot('create', CaseCoordinator::class)) {
        ...
        return Inertia::render('Custom/CaseCoordinator/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = CaseCoordinator::create($data);
        $entity->updateRelatedEntities($request);
        $statusText = 'Case Coordinator "' . $entity['name'] . '" has been created';
        ...
        // return redirect()->route('dashboard.case-coordinators.index')->with('success', $statusText);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return Inertia::render('Custom/CaseCoordinator/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Custom/CaseCoordinator/Edit', ['data' => $entity]);
    }
    ...
    {
        $entity = CaseCoordinator::findOrFail($id);
        ...
        $entity->updateRelatedEntities($request);
        $statusText = 'Case Coordinator "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'Case Coordinator "' . $entity['name'] . '" has been deleted';
        $entity->delete();
