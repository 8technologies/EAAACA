...
class CaseTypeController extends Controller
{
    ...
    {
        if ($request->user()->cannot('viewAny', CaseType::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Custom/CaseType/Index', []);
        }
    }
    ...
    {
        if ($request->user()->cannot('create', CaseType::class)) {
        ...
        return Inertia::render('Custom/CaseType/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = CaseType::create($data);
        $statusText = 'CaseType has been saved';

        if(checkAjaxJsonRequest($request))
        {
            return response($entity)->setStatusCode(200, $statusText);
        }
        return redirect()->route('dashboard.case-types.index')->with('success', $statusText);
    ...
    public function show(Request $request, $id)
    {
        ...
        return Inertia::render('Custom/CaseType/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Custom/CaseType/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $statusText = 'CaseType "' . $entity['id'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'CaseType "' . $entity['id'] . '" has been deleted';
        $entity->delete();
