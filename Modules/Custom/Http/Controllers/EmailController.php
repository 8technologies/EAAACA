...
class EmailController extends Controller
{
    ...
    {
        if ($request->user()->cannot('viewAny', Email::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Custom/Email/Index', []);
        }
    }
    ...
    {
        if ($request->user()->cannot('create', Email::class)) {
        ...
        return Inertia::render('Custom/Email/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = Email::create($data);
        $entity->updateRelatedEntities($request);
        $statusText = 'Email "' . $entity['name'] . '" has been created';

        if(checkAjaxJsonRequest($request))
        {
            return response($entity)->setStatusCode(200, $statusText);
        }
        return redirect()->route('dashboard.emails.index')->with('success', $statusText);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return Inertia::render('Custom/Email/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Custom/Email/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $entity->updateRelatedEntities($request);
        $statusText = 'Email "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'Email "' . $entity['name'] . '" has been deleted';
        $entity->delete();
