...
class InformationRestrictionController extends Controller
{
    /**
    ...
    {
        if ($request->user()->cannot('viewAny', InformationRestriction::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Custom/InformationRestriction/Index', []);
        }
    }
    ...
    {
        if ($request->user()->cannot('create', InformationRestriction::class)) {
        ...
        return Inertia::render('Custom/InformationRestriction/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = InformationRestriction::create($data);
        // $entity->updateRelatedEntities($request);
        $statusText = 'Information Restriction "' . $entity['name'] . '" has been created';

        if(checkAjaxJsonRequest($request))
        {
            return response($entity)->setStatusCode(200, $statusText);
        }
        return redirect()->route('dashboard.information-restrictions.index')->with('success', $statusText);
    }
    ...
    {
        $entity = InformationRestriction::findOrFail($id);
        ...
        return Inertia::render('Custom/InformationRestriction/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Custom/InformationRestriction/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // $entity->updateRelatedEntities($request);
        $statusText = 'Information Restriction "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'Information Restriction "' . $entity['name'] . '" has been deleted';
        $entity->delete();
