...
class MemberStateController extends Controller
{
    /**
    ...
    {
        if ($request->user()->cannot('viewAny', MemberState::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Custom/MemberState/Index', []);
        }
    }
    ...
    {
        if ($request->user()->cannot('create', MemberState::class)) {
        ...
        return Inertia::render('Custom/MemberState/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = MemberState::create($data);
        $entity->updateRelatedEntities($request);
        $statusText = 'Member State "' . $entity['name'] . '" has been created';

        if(checkAjaxJsonRequest($request))
        {
            return response($entity)->setStatusCode(200, $statusText);
        }
        return redirect()->route('dashboard.member-states.index')->with('success', $statusText);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return Inertia::render('Custom/MemberState/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Custom/MemberState/Edit', ['data' => $entity]);
    }
    ...
    {
        $entity = MemberState::findOrFail($id);
        ...
        $entity->updateRelatedEntities($request);
        $statusText = 'Member State "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'Member State "' . $entity['name'] . '" has been deleted';
        $entity->delete();
