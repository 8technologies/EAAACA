...
class NatureOfOffenceController extends Controller
{
    /**
    ...
    {
        if ($request->user()->cannot('viewAny', NatureOfOffence::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Custom/NatureOfOffence/Index', []);
        }
    }
    ...
    {
        if ($request->user()->cannot('create', NatureOfOffence::class)) {
        ...
        return Inertia::render('Custom/NatureOfOffence/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = NatureOfOffence::create($data);
        // $entity->updateRelatedEntities($request);
        $statusText = 'Nature Of Offence "' . $entity['name'] . '" has been created';

        if(checkAjaxJsonRequest($request))
        {
            return response($entity)->setStatusCode(200, $statusText);
        }
        return redirect()->route('dashboard.nature-of-offences.index')->with('success', $statusText);
    }
    ...
    {
        $entity = NatureOfOffence::findOrFail($id);
        ...
        return Inertia::render('Custom/NatureOfOffence/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Custom/NatureOfOffence/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // $entity->updateRelatedEntities($request);
        $statusText = 'Nature Of Offence "' . $entity['name'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'Nature Of Offence "' . $entity['name'] . '" has been deleted';
        $entity->delete();
