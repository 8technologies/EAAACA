...
class CountryController extends Controller
{
    ...
    {
        if ($request->user()->cannot('viewAny', Country::class)) {
        ...
        if(checkAjaxJsonRequest($request))
        {
            ...
            return Inertia::render('Custom/Country/Index', []);
        }
    }
    ...
    public function create(Request $request)
    {
        ...
        return Inertia::render('Custom/Country/Create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entity = Country::create($data);
        $statusText = 'Country has been saved';

        if(checkAjaxJsonRequest($request))
        {
            return response($entity)->setStatusCode(200, $statusText);
        }
        return redirect()->route('dashboard.countries.index')->with('success', $statusText);
    ...
    public function show(Request $request, $id)
    {
        ...
        return Inertia::render('Custom/Country/Show', ['data' => $entity]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Custom/Country/Edit', ['data' => $entity]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $statusText = 'Country "' . $entity['id'] . '" has been updated';
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $statusText = 'Country "' . $entity['id'] . '" has been deleted';
        $entity->delete();
