...
class ContentBlogPost extends Model
{
    use HasFactory;
    use ContentModel;
    use HasMediaField;
    ...
    protected $searchable = [
         ...
         */
        'columns' => [
            'content_blog_posts.title' => 10,
            'content_blog_posts.body' => 10,
        ],
    ];
    ...
    public function getEntityLinksAttribute()
    {
        ...
        $links = [
            'url'  => route('blog.show', [$urlParam]),
            'url_view'  => route('dashboard.blog-posts.show', [$this->attributes['id']]),
            'url_edit'  => route('dashboard.blog-posts.edit', [$this->attributes['id']]),
        ];
    ...
    {
        return \Modules\Content\Database\factories\ContentBlogPostFactory::new();
    }
}
