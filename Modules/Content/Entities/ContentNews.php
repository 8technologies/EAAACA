...
class ContentNews extends Model
{
    ...
    protected $searchable = [
         ...
         */
        'columns' => [
            'content_news.title' => 10,
            'content_news.body' => 10,
            // 'users.name' => 5,
            // 'users.email' => 5,
        ],
        // 'joins' => [
        //     'users' => ['content_news.user_id','users.id'],
        // ],
    ];
    ...
    public function getEntityLinksAttribute()
    {
        ...
        $links = [
            'url'  => route('news.show', [$urlParam]),
            'url_view'  => route('dashboard.news.show', [$this->attributes['id']]),
            'url_edit'  => route('dashboard.news.edit', [$this->attributes['id']]),
        ];
    ...
    {
        return \Modules\Content\Database\factories\ContentNewsFactory::new();
    }
}
