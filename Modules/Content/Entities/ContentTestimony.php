...
class ContentTestimony extends Model
{
    use HasFactory;
    use ContentModel;
    use HasMediaField;
    ...
    protected $searchable = [
         ...
         */
        'columns' => [
            'content_testimonies.name' => 10,
            'content_testimonies.company_name' => 10,
            'content_testimonies.testimony' => 10,
        ],
    ];
    ...
    public function getEntityLinksAttribute()
    {
        ...
        $links = [
            'url'  => route('testimonies.show', [$urlParam]),
            'url_view'  => route('dashboard.testimonies.show', [$this->attributes['id']]),
            'url_edit'  => route('dashboard.testimonies.edit', [$this->attributes['id']]),
        ];
    ...
    {
        return \Modules\Content\Database\factories\ContentTestimonyFactory::new();
    }
}
