...
class ContentGallery extends Model
{
    ...
    protected $searchable = [
         ...
         */
        'columns' => [
            'content_galleries.title' => 10,
            'content_galleries.body' => 10,
        ],
    ];
    ...
    public function getEntityLinksAttribute()
    {
        ...
        $links = [
            'url'  => route('gallery.show', [$urlParam]),
            'url_view'  => route('dashboard.gallery.show', [$this->attributes['id']]),
            'url_edit'  => route('dashboard.gallery.edit', [$this->attributes['id']]),
        ];
    ...
    {
        return \Modules\Content\Database\factories\ContentGalleryFactory::new();
    }
}
