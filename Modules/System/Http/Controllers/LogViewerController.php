...
class LogViewerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            'chartdata' => $percents,
            'logs' => $this->listLogs($request)
        ];

        return Inertia::render('Core/System/LogViewer/Index', $data);
    }
    ...
    public function show(Request $request, $date)
    {
        $data = [];
        $data['level']   = 'all';
        $data['log']     = $this->getLogOrFail($date);
        $data['query']   = $request->get('query');
        $data['levels']  = $this->logViewer->levelsNames();

        $data['name']    = $date;
        $data['size']    = $data['log']->size();
        $data['created_at']    = $data['log']->createdAt();
        $data['updated_at']    = $data['log']->updatedAt();
        $data['stats']    = $data['log']->stats();
        $data['count']    = $data['log']->entries()->count();

        return Inertia::render('Core/System/LogViewer/Show', ['data' => $data]);
    ...
    public function delete(Request $request)
    {
        ...
        $statusText = 'Log "' . $date . '" has been deleted';
