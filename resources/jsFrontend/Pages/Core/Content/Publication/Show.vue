    ...
    <app-layout :data="data">
        ...
        <template #pageBreadcrumb>
            <ol class="breadcrumb p-0 d-inline-flex bg-transparent">
                ...
                <li class="breadcrumb-item">
                    <inertia-link :href="route('publications')" class="">
                        Publication
                    </inertia-link>
                </li>
            </ol>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 content">
                ...
                <div v-if="data.media_attachments[0]" class="pt-5">
                    <h5 class="border-bottom pb-1">Downloads</h5>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                pageTitle: this.data.name + ' - Publications',
