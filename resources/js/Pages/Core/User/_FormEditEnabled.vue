<template>
    <div>
        <b-form @submit="update" :action="route('dashboard.users.update-enabled', data.id)" method="PUT">
            ...
            <div class="">
                ...
                <b-row class="form-group">
                    ...
                    <b-col sm="9">
                        ...
                        <span v-if="errors.enabled" :class="['label text-danger small']">{{ errors.enabled }}</span>
                    </b-col>
                </b-row>
        ...
        data() {
            return {
                form: this.$inertia.form({
                    enabled: this.data.enabled ? this.data.enabled : '',
                    notify_user: 1,
                }),
            }
        },
