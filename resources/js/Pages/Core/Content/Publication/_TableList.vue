<template>
    ...
    <div class="">
        ...
        <div id="toolbar">
            <inertia-link :href="route('dashboard.publications.create')" class="btn btn-primary">
        ...
        <BootstrapTable
            ...
            :columns="columns"
            :options="options"
            :data-url="route('dashboard.publications.index')">
        </BootstrapTable>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                addModalTitle: '#Add a Publication Page',
                columns: [{
                    field: 'state',
                    checkbox: true
                }, {
