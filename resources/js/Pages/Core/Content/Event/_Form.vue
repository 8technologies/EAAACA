                ...
                <div class="col-md-6">
                    <div class="form-group position-relative">
                        ...
                        <date-picker 
                            ...
                            type="datetime" 
                            value-type="format" 
                            :class="[errors.starting_date ? 'is-invalid' : '']">
                        </date-picker>
                        <span v-if="errors.starting_date" :class="['label text-danger small']">{{ errors.starting_date }}</span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group position-relative">
                        ...
                        <date-picker 
                            ...
                            type="datetime" 
                            value-type="format" 
                            :class="[errors.ending_date ? 'is-invalid' : '']">
                        </date-picker>
                        <span v-if="errors.ending_date" :class="['label text-danger small']">{{ errors.ending_date }}</span>
                    </div>
                </div>
            </div>
        ...
        data() {
          return {
                form: this.$inertia.form({
                    ...
                    starting_date: this.data && this.data.starting_date ? this.data.starting_date : '',
                    ending_date: this.data && this.data.ending_date ? this.data.ending_date : '',
                    image: null,
                    image_id: null,
                    attachments: null,
                    attachments_ids: [],
