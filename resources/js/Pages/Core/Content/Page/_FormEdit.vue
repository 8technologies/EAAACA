<template>
    <div>
        <b-form @submit="update" :action="route('dashboard.pages.update', data.id)" method="PUT">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <b-form-textarea id="introduction_text" rows="3" max-rows="3" placeholder="Enter introduction text" 
                            v-model="form.introduction_text" 
                            :class="[errors.introduction_text ? 'is-invalid' : '']">
                        </b-form-textarea>
                        <span v-if="errors.introduction_text" :class="['label text-danger small']">{{ errors.introduction_text }}</span>
                    </div>
        ...
        data() {
          return {
                form: this.$inertia.form({
                    ...
                    introduction_text: this.data && this.data.introduction_text ? this.data.introduction_text : '',
