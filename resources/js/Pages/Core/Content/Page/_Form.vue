        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="form-group">
                    ...
                    <b-form-input id="title" placeholder="Enter Title" required="" v-model="title" :class="[errors.title ? 'is-invalid' : '']">
                    </b-form-input>
                ...
                <!-- <div class="form-group">
                    ...
                    <b-form-textarea id="intro" rows="4" max-rows="6" placeholder="Enter intro text" 
                        v-model="form.intro" 
                        :class="[errors.intro ? 'is-invalid' : '']">
                    </b-form-textarea>
                    <span v-if="errors.intro" :class="['label text-danger small']">{{ errors.intro }}</span>
                </div> -->

                <!-- <div class="form-group">
                    <label for="image">Image</label>
                    <field-image :data="data"/>
                </div> -->

                <div class="form-group">
                    <label for="body">Body</label>
                    <ckeditor :editor="editor" v-model="body" :config="editorConfig" :class="[errors.body ? 'is-invalid' : '']"></ckeditor>
        ...
        data() {
          return {
                form: this.$inertia.form({
                    ...
                    // intro: this.data && this.data.intro ? this.data.intro : '', 
                    ...
                    slug: this.data.slug ? this.data.slug : '',
                ...
                entityUpdateUrlTop: route('dashboard.pages.updatepagesectiontops', this.data.id),
                returnJson: true,
                isProcessing: false,
            }
        },
