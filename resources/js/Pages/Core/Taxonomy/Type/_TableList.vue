<template>
    ...
    <div class="">
        ...
        <div id="toolbar">
            <b-link :href="route('dashboard.taxonomy_types.create')" class="add-item btn btn-primary">
        ...
        <BootstrapTable
            ...
            :columns="columns"
            :options="options"
            :data-url="route('dashboard.taxonomy_types.index')">
        </BootstrapTable>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                addModalTitle: '#Add a Taxonomy Type',
                columns: [{
                    field: 'state',
                    checkbox: true
                }, {
