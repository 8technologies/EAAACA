<template>
    <div class="live-edit-wrapper">
        ...
        <div class="row no-gutters text-secondary draggable-area draggable-section-header">
            <div class="col">
                ...
                <div class="d-inline">
                    <b-dropdown id="dropdown-1" variant="link" size="md" toggle-class="text-decoration-none p-0" no-caret>
                        ...
                        <b-dropdown-item :href="route('dashboard.layout_section_tops.addrow', localData.id)" class="" v-on:click="showAddSilently($event)">
                            Add a Row
                        </b-dropdown-item>
                        <b-dropdown-item :href="route('dashboard.layout_section_tops.createfieldblock', localData.id)" class="" v-on:click="showAddFieldBlock($event)">
                            Add a Block
                        </b-dropdown-item>
                    </b-dropdown>
                </div>
            ...
            <div class="col-">
                <b-link :href="route('dashboard.layout_section_tops.show', localData.id)" class="text-secondary" v-on:click="showEntity($event)">
                    <i class="fa fa-eye"></i>
                </b-link>
                <b-link :href="route('dashboard.layout_section_tops.edit', localData.id)" class="text-secondary" v-on:click="showEntityEdit($event)">
                    <i class="fa fa-pencil-alt"></i>
                </b-link>
                <b-link :href="route('dashboard.layout_section_tops.show', localData.id)" class="text-secondary" v-on:click="showEntityDelete($event)">
        ...
        <div class="section-top pt-4" :class="attributeClass" :style="_styles" v-bind="dataJarallaxVideoAttribute">
...
<script>
    ...
    import EntityCreateFieldBlock from '@/Pages/Core/Field/FieldBlock/_FormCreateLayoutSectionTop'
    ...
    export default {
        ...
        data() {
            return {
                ...
                entityUpdateUrl: route('dashboard.layout_section_tops.updaterows', this.data.id),
                returnJson: true,
                isProcessing: false,
            }
        },
