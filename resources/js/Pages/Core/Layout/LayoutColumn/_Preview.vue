<template>
    <div :class="classes + ' rounded'">
        <div class="border rounded bg-light">
            <div class="border-bottom rounded py-1 px-3">
                ...
                <div class="col">
                    ...
                    <div class="d-inline">
                        <b-dropdown id="dropdown-1" variant="link" size="md" toggle-class="text-decoration-none p-0" no-caret>
                            ...
                            <b-dropdown-item :href="route('dashboard.layout_columns.createfieldlink', localData.id)" class="" v-on:click="showAddFieldText($event)">
                                Add a Link
                            </b-dropdown-item>
...
<script>
    ...
    import fieldTitlePreview from '@/Pages/Core/Field/FieldTitle/_Preview'
    import fieldTextPreview from '@/Pages/Core/Field/FieldText/_Preview'
    import fieldLinkPreview from '@/Pages/Core/Field/FieldLink/_Preview'
    import fieldImagePreview from '@/Pages/Core/Field/FieldImage/_Preview'
    import fieldHtmlPreview from '@/Pages/Core/Field/FieldHtml/_Preview'
