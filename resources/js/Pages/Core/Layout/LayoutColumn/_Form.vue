            ...
            <b-tab title="General" active>
                <div>
                    <b-row class="form-group">
                        <b-col sm="3">
                            <label for="layout_row_id">Parent Row</label>
                        </b-col>
                        <b-col sm="9">
                            <b-form-input id="layout_row_id" placeholder="Enter Row" disabled v-model="data.layout_row.name" :class="[errors.layout_row_id ? 'is-invalid' : '']">
                            </b-form-input>
                            <span v-if="errors.layout_row_id" :class="['label text-danger small']">{{ errors.layout_row_id }}</span>
                        </b-col>
                    </b-row>
                    ...
                    <b-row class="form-group">
                        ...
                        <b-col sm="9">
                            <b-form-input id="width" placeholder="Enter Width" v-model="form.width" :class="[errors.width ? 'is-invalid' : '']">
                            </b-form-input>
                            <span v-if="errors.width" :class="['label text-danger small']">{{ errors.width }}</span>
                        </b-col>
                    </b-row>
                ...
                <div class="accordion" role="tablist">
                    <b-card no-body class="mb-0">
                        <b-card-header header-tag="header" role="tab">
                            <b-button block v-b-toggle.accordion-2 variant="link">Background styles <i class="fa fa-angle-right"></i></b-button>
                        </b-card-header>
                        <b-collapse id="accordion-2" accordion="general-accordion" role="tabpanel">
                            <b-card-body>
                                <b-row class="form-group">
                                    <b-col sm="3">
        ...
        data() {
          return {
                form: this.$inertia.form({
                    layout_row_id: this.data.layout_row_id,
