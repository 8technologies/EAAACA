<template>
    ...
    <div class="">
        ...
        <div id="toolbar">
            <b-link :href="route('dashboard.permission_types.create')" class="add-item btn btn-primary">
        ...
        <BootstrapTable
            ...
            :columns="columns"
            :options="options"
            :data-url="route('dashboard.permission_types.index')">
        </BootstrapTable>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                addModalTitle: '#Add a Permission Types',
                columns: [{
                    field: 'state',
                    checkbox: true
                }, {
