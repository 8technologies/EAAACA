            ...
            <b-tab title="Content" active>
                <div>
                    <b-row class="form-group">
                        ...
                        <b-col sm="9">
                            <b-input id="link" placeholder="Enter link" v-model="form.link" :class="[errors.link ? 'is-invalid' : '']">
                            </b-input>
                            <span v-if="errors.link" :class="['label text-danger small']">{{ errors.link }}</span>
                        </b-col>
                    </b-row>

                    <b-row class="form-group">
                        <b-col sm="3">
                            <label>Link text/markup</label>
                        </b-col>
                        <b-col sm="9">
                            <b-textarea id="link_text" rows="2" max-rows="4" placeholder="Enter link text/markup" v-model="form.link_text" :class="[errors.link_text ? 'is-invalid' : '']">
                            </b-textarea>
                            <span v-if="errors.link_text" :class="['label text-danger small']">{{ errors.link_text }}</span>
                        </b-col>
                    </b-row>
