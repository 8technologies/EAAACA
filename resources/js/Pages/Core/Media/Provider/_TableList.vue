<template>
    ...
    <div class="">
        <div id="toolbar">
            <b-link :href="route('dashboard.media.providers.create')" class="add-item btn btn-primary">
        ...
        <BootstrapTable
            ...
            :columns="columns"
            :options="options"
            :data-url="route('dashboard.media.providers.index')">
        </BootstrapTable>
