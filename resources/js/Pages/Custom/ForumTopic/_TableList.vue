<template>
    ...
    <div class="">
        ...
        <div id="toolbar">
            <inertia-link :href="route('dashboard.forum-topics.create')" class="btn btn-primary">
        ...
        <BootstrapTable
            ...
            :columns="columns"
            :options="options"
            :data-url="route('dashboard.forum-topics.index')">
        </BootstrapTable>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                addModalTitle: '#Add an Forum topic',
                columns: [{
                    field: 'state',
                    checkbox: true
                }, {
