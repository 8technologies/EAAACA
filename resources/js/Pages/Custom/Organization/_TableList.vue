<template>
    ...
    <div class="">
        <div id="toolbar">
            <b-link :href="route('dashboard.organizations.create')" class="add-item btn btn-primary">
        ...
        <BootstrapTable
            ...
            :columns="columns"
            :options="options"
            :data-url="route('dashboard.organizations.index')">
        </BootstrapTable>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                addModalTitle: '#Add an Organization',
                columns: [{
                    field: 'state',
                    checkbox: true
                }, {
                    ...
                    field: 'contact_points_count',
                    title: 'Contact points',
                    width: '100',
                    sortable: false,
                    visible: true,
                }, {
                    field: 'information_requests_count',
                    ...
                    visible: true,
                    formatter: (value, row) => {
                        return row.member_state? row.member_state.name : ''
                    },
                }, {
                    field: 'updated_at',
                    title: 'Updated At',
