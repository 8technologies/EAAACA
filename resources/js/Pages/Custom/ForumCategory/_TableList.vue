<template>
    ...
    <div class="">
        <div id="toolbar">
            <b-link :href="route('dashboard.forum-categories.create')" class="add-item btn btn-primary">
        ...
        <BootstrapTable
            ...
            :columns="columns"
            :options="options"
            :data-url="route('dashboard.forum-categories.index')">
        </BootstrapTable>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                addModalTitle: '#Add a Forum Category',
                columns: [{
                    field: 'state',
                    checkbox: true
                }, {
