<template>
    ...
    <div class="">
        <div id="toolbar">
            <b-link :href="route('dashboard.case-findings.create')" class="add-item btn btn-primary">
        ...
        <BootstrapTable
            ...
            :columns="columns"
            :options="options"
            :data-url="route('dashboard.case-findings.index')">
        </BootstrapTable>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                addModalTitle: '#Add a Case Findings',
                columns: [{
                    field: 'state',
                    checkbox: true
                }, {
                    ...
                    field: 'case_investigation_id',
                    title: 'Case investigation',
                    width: '220',
                    sortable: 'true',
                    visible: true,
                    formatter: (value, row) => {
                        return row.case_investigation.name
                    },
                }, {
                    field: 'updated_at',
                    title: 'Updated At',
