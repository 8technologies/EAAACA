<template>
    ...
    <div class="">
        <div id="toolbar">
            <b-link :href="route('dashboard.information-restrictions.create')" class="add-item btn btn-primary">
        ...
        <BootstrapTable
            ...
            :columns="columns"
            :options="options"
            :data-url="route('dashboard.information-restrictions.index')">
        </BootstrapTable>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                addModalTitle: '#Add Information restriction',
                columns: [{
                    field: 'state',
                    checkbox: true
                }, {
