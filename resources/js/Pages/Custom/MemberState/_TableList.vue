<template>
    ...
    <div class="">
        <div id="toolbar">
            <b-link :href="route('dashboard.member-states.create')" class="add-item btn btn-primary">
        ...
        <BootstrapTable
            ...
            :columns="columns"
            :options="options"
            :data-url="route('dashboard.member-states.index')">
        </BootstrapTable>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                addModalTitle: '#Add a Member State',
                columns: [{
                    field: 'state',
                    checkbox: true
                }, {
