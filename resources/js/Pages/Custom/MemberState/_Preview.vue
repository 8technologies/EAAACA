            ...
            <div class="col-">
                <div class="">
                    <b-dropdown  variant="link" toggle-class="text-decoration-none p-0" no-caret right>
                        ...
                        <b-dropdown-item :href="route('dashboard.member-states.show', data.id)" class="" v-on:click="showEntity($event)">
                            View
                        </b-dropdown-item>
                        <b-dropdown-item :href="route('dashboard.member-states.edit', data.id)" class="" v-on:click="showEntityEdit($event)">
                            Edit
                        </b-dropdown-item>
                        <b-dropdown-item :href="route('dashboard.member-states.show', data.id)" class="" v-on:click="showEntityDelete($event)">
                            Delete
                        </b-dropdown-item>
                    </b-dropdown>
                </div>               
